...
public interface RequestRepository extends JpaRepository<Request,Long> {
	...
	@Query("select new com.price.comparision.ecom.bean.AdminStats(requestDate, count(1)) from Request where requestStatus = 'N' group by requestDate order by requestDate desc")
